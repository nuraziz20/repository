...
SI.regulated<-fc %>% 
  filter(grupSI == 'Downregulated' | grupSH == 'Upregulated')
REC.regulated<-fc %>% 
  filter(grupREC == 'Downregulated' | grupSH == 'Upregulated')
...
```
<br>
* From venn we can see about 871 DEGs overlap, then we filter again and assign positive or negatively regulated by PRMT1
<br>
