...
```
<br>
* From venn we can see about 131 DEGs overlap, then we filter again and assign positive or negatively regulated by PRMT1
<br>
...
DT::datatable(overlap)

```

### Final filtering Positive/Negative

<br>

#### Positively regulated by PRMT1
```{r final, echo=TRUE, message=FALSE, warning=FALSE}
Positive.cor<-(overlap %>% filter(grupSH == 'Downregulated' & grupSI == 'Downregulated' & grupREC == 'Upregulated'))
DT::datatable(Positive.cor)
```
<br>

#### Negatively regulated by PRMT1
```{r final2, echo=TRUE, message=FALSE, warning=FALSE}

Negative.cor<-(overlap %>% filter(grupSH == 'Upregulated' & grupSI == 'Upregulated' & grupREC == 'Downregulated'))
DT::datatable(Negative.cor)
```
